...
public class ProcessoTabelaDAO {
    ...
    private static final String SQL_INSERT =
            "INSERT INTO TB_REPLICACAO_PROCESSO_TABELA (" +
                    "PROCESSO_ID, TABELA_ORIGEM, TABELA_DESTINO, ORDEM, HABILITADO, DS_WHERE)" +
                    "VALUES (?, ?, ?, ?, ?, ?)";

    private static final String SQL_UPDATE =
            "UPDATE TB_REPLICACAO_PROCESSO_TABELA SET PROCESSO_ID = ?, TABELA_ORIGEM = ?," +
                    "TABELA_DESTINO = ?, ORDEM = ?, HABILITADO = ?, DS_WHERE = ?" +
                    "WHERE ID = ?";

    private static final String SQL_DELETE =
            "DELETE TB_REPLICACAO_PROCESSO_TABELA WHERE ID = ?";
    ...
    public void update(TB_REPLICACAO_PROCESSO_TABELA processo) throws SQLException {
        ...
        pstUpdate.setLong(7, processo.getId());
